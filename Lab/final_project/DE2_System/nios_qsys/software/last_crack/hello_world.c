...
#define CALIBRATE_DATA  		(int *) 0x01001040
#define CALIBRATE_X				(int *) 0x01001041
#define CALIBRATE_Y  			(int *) 0x01001042
#define CALIBRATE_MEM_OFF  		(volatile int *) 0x01001043
#define CALIBRATE_GAIN  		(int *) 0x01001044
#define CALIBRATE_OFFSET  		(int *) 0x01001045
#define CALIBRATE_DATA_CAL  	(volatile int *) 0x01001046

#define LEDs 	 				(int *) 0x01001060
#define Switches  				(volatile int *) 0x01001070
