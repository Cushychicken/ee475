...
#define CALIBRATE_X				(int *) 0x01001001
#define CALIBRATE_Y  			(int *) 0x01001002
#define CALIBRATE_MEM_OFF  		(volatile int *) 0x01001003
#define CALIBRATE_GAIN  		(int *) 0x01001004
#define CALIBRATE_OFFSET  		(int *) 0x01001005
#define CALIBRATE_DATA_CAL  	(volatile int *) 0x01001006
#define CALIBRATE_MEM_PRODUCT  	(volatile int *) 0x01001007
#define CALIBRATE_GAIN_PRODUCT  (volatile int *) 0x01001008
